...
const loveObjects = ["heart", "flower", "candle", "ring", "hug", "kiss", "book", "pillow", "key", "painting", "letter", "mirror", "jigsaw", "puzzle", "lock", "key", "photo", "album", "bridge", "tree", "umbrella", "gift", "map", "compass", "sculpture", "statue", "treasure", "box", "chocolate", "teapot", "cushion", "bottle", "bracelet", "jewelry", "drawer", "calendar", "ticket", "photograph", "bookmark", "blanket", "scarf", "journal", "cup", "telephone", "bag", "notebook", "soap", "cloud", "star", "moon"];
